...
Nota           :  Estructura adaptada desde SQL Server para MySQL
*/
...
-- Crear el usuario para acceso desde localhost
CREATE USER IF NOT EXISTS 'eureka'@'localhost' IDENTIFIED BY 'admin';
GRANT ALL PRIVILEGES ON eurekabank.* TO 'eureka'@'localhost';

-- Aplicar los cambios de privilegios
FLUSH PRIVILEGES;

-- Volver a la base de datos eurekabank para terminar
USE eurekabank;
